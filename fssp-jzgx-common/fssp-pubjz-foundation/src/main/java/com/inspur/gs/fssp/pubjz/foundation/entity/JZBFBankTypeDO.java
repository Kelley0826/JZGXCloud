...
public class JZBFBankTypeDO {
     ...
     * 获取 是否系统预制
     *
     * @return issyspreset 是否系统预制
     */
    public Character getIssyspreset() {
     ...
     * 设置 是否系统预制
     *
     * @param issyspreset 是否系统预制
     */
    public void setIssyspreset(Character issyspreset) {
