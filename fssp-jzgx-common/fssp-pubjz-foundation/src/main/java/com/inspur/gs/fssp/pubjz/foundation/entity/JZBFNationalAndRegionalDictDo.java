 ...
 * 国家地区
 */
public class JZBFNationalAndRegionalDictDo {
    /**
     * id
     */
    private String id;
    ...
    public String toString() {
        return "BFNationalAndRegionalDictDo{" +
                "id='" + id + '\'' +
                ", code='" + code + '\'' +
